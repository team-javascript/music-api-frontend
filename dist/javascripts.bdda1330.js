...
function () {
  ...
  _createClass(Components, [{
    ...
    value: function renderPageSong(data) {
      ...
      var ratingUpButton = (0, _Html.default)().create("button").addClass("ratingUp-button").click(function () {
        (0, _Api.default)().getRequest("http://localhost:3000/songs/".concat(data._id, "/increaseRating"), function (song) {
          (0, _Html.default)().select(".content-block__list-item--rating").text(song.rating);
        });
      });
